...
// CODE HERE
const resetHelloButton = event => {
    console.log("mouse out")
    event.target.style.backgroundColor = "#EFEFEF";
    event.target.style.color = "black";
}

sayHelloButton.addEventListener('mouseout', resetHelloButton);
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/testing').then((res) => {
...
// CODE HERE
const queryTest = () => {
    axios.get('http://localhost:3000/query-test/?myquery&?newquery').then((res) => {
        console.log(res.data);
    })
}
